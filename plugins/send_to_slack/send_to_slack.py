...
def execute(message, channel, file_bytes, file=None, file_type=None, title=None):
    token = os.getenv ("xoxb-4584092705267-4634559437795-XtRNAH3umFMJclTsZUqbpfpN")
    slack_token = token
...
if __name__=='__main__':
     execute('test','#automate_report', 'D:\SUSI\automate_report\output\sales_per_month.png', file=None, file_type=None, title=None)